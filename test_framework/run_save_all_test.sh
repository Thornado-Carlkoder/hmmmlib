...
mkdir -p running_times



echo "# running_time_A1#"
python running_time_A1.py > running_times/running_time_A1.csv

echo "# running_time_A2#"
python running_time_A2.py > running_times/running_time_A2.csv

echo "# running_time_B1#"
python running_time_B1.py > running_times/running_time_B1.csv

echo "# running_time_B2#"
python running_time_B2.py > running_times/running_time_B2.csv

echo "# running_time_C1#"
python running_time_C1.py > running_times/running_time_C1.csv

echo "# running_time_C2#"
python running_time_C2.py > running_times/running_time_C2.csv

echo "# running_time_C3#"
python running_time_C3.py > running_times/running_time_C3.csv

echo "# running_time_C4#"
